...
| Static integration | LoadControl, ArcLength, ArcLengthLinear; force and displacement control | Dynamic Newmark/HHT/Wilson paths are outside V1. |
...
| Modal | Consistent/lumped mass paths represented by HRX, eigensolution, mass normalization, participation, effective mass, mode-shape projection | Response-spectrum contributions and nonlinear dynamics are outside V1. |
